...
class CekBarangAdminDaerahPage extends StatefulWidget {
  const CekBarangAdminDaerahPage({Key? key}) : super(key: key);

  @override
  _CekBarangAdminDaerahPageState createState() => _CekBarangAdminDaerahPageState();
}

class _CekBarangAdminDaerahPageState extends State<CekBarangAdminDaerahPage> {
