...
class CekBarangUserPage extends StatefulWidget {
  const CekBarangUserPage({Key? key}) : super(key: key);

  @override
  _CekBarangUserPageState createState() => _CekBarangUserPageState();
}

class _CekBarangUserPageState extends State<CekBarangUserPage> {
